...
const pageContainerVariants = cva(
  'rounded-xl border border-container-border bg-container text-container-foreground shadow h-full overflow-hidden',
  {
    variants: {
      shadow: {
        default: 'shadow',
...
const contentVariants = cva(
  'py-10 h-full overflow-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-border hover:scrollbar-thumb-muted-foreground dark:scrollbar-thumb-border dark:hover:scrollbar-thumb-muted-foreground',
  {
    variants: {
      variant: {
