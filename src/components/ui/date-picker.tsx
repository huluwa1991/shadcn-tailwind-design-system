...
export interface DatePickerProps
  extends Omit<React.ComponentPropsWithoutRef<typeof Button>, "value" | "onChange" | "variant" | "size"> {
  value?: Date
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            variant="outline"
            className={cn(
              "justify-start text-left font-normal h-9 px-3 text-sm w-auto min-w-[200px]",
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            variant="outline"
            className={cn(
              "justify-start text-left font-normal h-9 px-3 text-sm w-auto min-w-[300px]",
